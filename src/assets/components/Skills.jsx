...
function Skills() {
  return (
    <section>
      <div className="skill-details items-center flex flex-col border-4 border-green-400 p-4">
        <h2 className="mt-16">Skills</h2>
        <p className="text-center">I have a broad range of skills that will enable me to be a valuable member of your team. </p>
