...
function handleClickBurger() {
  ...
  return (
    <header className="sm:items-center relative flex justify-between sm:p-8 bg-orange-300 w-full ">
      ...
      <nav className={`${isOpenBurger ? "visible" : "invisible"}  sm:visible p-6 bg-orange-300 w-full absolute text-white  border border-red-400 gap-8 flex-col flex sm:flex-row sm:static sm:p-0 sm:justify-end sm:items-baseline  text-white  text-xl`}>
        <NavLink
          to="/"
